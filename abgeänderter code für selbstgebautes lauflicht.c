...
int main(void) {
  ...
  gpio_output(LED_PIN_2);
  gpio_output(LED_PIN_3);
  gpio_output(LED_PIN_4);
  gpio_output(LED_PIN_5);
  gpio_output(LED_PIN_6);
  ...
  for (;;) {
    ...
    i = 0;
    for(; i < 1000000; ++i) ;
    gpio_toggle(LED_PIN_3);
    i = 0;
    for(; i < 1000000; ++i) ;
    gpio_toggle(LED_PIN_4);
    i = 0;
    for(; i < 1000000; ++i) ;
    gpio_toggle(LED_PIN_5);
    i = 0;
    for(; i < 1000000; ++i) ;
    gpio_toggle(LED_PIN_6);
